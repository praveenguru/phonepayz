...
class MobileTransactionPage extends StatefulWidget{
  @override
  _MobileTransactionPageState createState() => _MobileTransactionPageState();
}
...
class _MobileTransactionPageState extends State<MobileTransactionPage> {
  ...
  getAllTransactions(String token){
    ...
    ApiProvider().getAllTransactions(token, "MobileRecharge").then((response){
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          columns: [
            ...
            DataColumn(
              label: Text("Mobile Number",style: TextStyle(fontWeight: FontWeight.bold),),
              numeric: false,
            ),
            DataColumn(
